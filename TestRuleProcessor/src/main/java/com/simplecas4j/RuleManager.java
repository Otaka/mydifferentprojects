...
public class RuleManager {
    ...
    public void initRules() {
        addRule(operator("+", RuleManager.this.number("0").setLabel("zeroLiteral"), anyExpression()), replacement(removeLabeledGroup("zeroLiteral")));
        addRule(operator("*", RuleManager.this.number("0"), anyExpression().setLabel("expression")), replacement(removeLabeledGroup("expression")));
        addRule(operator("*", RuleManager.this.number("1").setLabel("literal"), anyExpression().setLabel("expression")), replacement(removeLabeledGroup("literal")));
