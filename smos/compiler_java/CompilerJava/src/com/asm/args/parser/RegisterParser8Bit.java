 ...
 * @author sad
 */
public class RegisterParser8Bit extends AbstractParser {

    private String[] registers = new String[]{"al", "cl", "dl", "bl", "ah", "ch", "dh", "bh"};
    ...
    public AbstractParseResult parse(String value, Context context) {
        ...
        for (int i = 0; i < registers.length; i++) {
            if (value.equals(registers[i])) {
                return new RegisterResult(registers[i], 8, codes[i], RegisterResult.REG_TYPE.GENERAL);
            }
        }
